...
# --- Funktion um Serverstatus zu holen ---
...
# --- HTML Template mit allen Design-Funktionen ---
HTML_TEMPLATE = """
<!doctype html>
<html lang="de">
<head>
...
async function refresh() {
    ...
    for (const [player, times] of Object.entries(sessions)) {
        ...
        let total = times.total ? times.total.seconds || 0 : 0;
...
# --- Funktion zum Starten im Hauptthread ---
def start_web():
